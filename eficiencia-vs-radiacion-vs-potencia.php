...
if(isset($_SESSION['nickname'])){	
	...
	$sql_sesion = "SELECT * FROM usuarios WHERE nickname = '$nickname'";
	$resultado = $mysqli->query($sql_sesion);
...
<head>
	...
	<title>CDI Eficiencia Radiación Potencia | Adm: <?php echo $_SESSION['nickname'];?></title>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
			...
			<li class="active"><a href="eficiencia-vs-radiacion-vs-potencia.php"><i class="fa fa-circle-o"></i> Eficiencia Radiación Potencia [w]</a></li>
			<li class="treeview">
				<a href="#">
  ...
  <!-- Content Wrapper. Contains page content -->
	...
	<section class="col-lg-12 connectedSortable">
		...
		<div class="box-header">
		  <i class="fa fa-line-chart margin_right_0"></i>
		  <i class="fa fa-sun-o margin_right_0"></i>
		  <i class="fa fa-flash margin_right_0"></i>
		  <h3 class="box-title">Eficiencia Radiación Potencia</h3>
		...
		<iframe src="grafs/efivsrsvspt/" style="overflow:hidden;width: 100%;border: none;border-radius: 10px;min-height: 316px;padding: 0;margin: 0;"></iframe>

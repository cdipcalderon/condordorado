...
setcookie("TestCookie", $value, time()+3600, "/cookies/", "utilizada.php", 1);
...
<head>
	...
	<title>CDI | Utilizada | Adm: <?php echo $_SESSION['nickname'];?></title>
          ...
          <ul class="treeview-menu">
			...
			<li class="treeview active">
				...
				<ul class="treeview-menu">
					...
					<li class="active"><a href="utilizada.php"><i class="fa fa-circle-o"></i> Utilizada</a></li>
				</ul>
			</li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
	...
	<section class="col-lg-7 connectedSortable">
		...
		<div class="box-header">
		  ...
		  <h3 class="box-title">Energía Utilizada 1 semana Atras</h3>
		...
		<div class="box-body no-padding">
			<iframe src="grafs/utilizada2/" style="overflow:hidden;width: 100%;border: none;border-radius: 10px;min-height: 316px;padding: 0;margin: 0;"></iframe>
		</div>
	  </div>
	</section>

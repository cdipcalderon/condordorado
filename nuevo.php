...
setcookie("TestCookie", $value, time()+3600, "/cookies/", "monitor.php", 1);
...
<head>
	...
	<title>CDI Monitor| Adm: <?php echo $_SESSION['nickname'];?></title>
	<meta name="robots" content="index, nofollow">
	<link rel="icon" src="imgs/favicon.ico" type="image/x-icon">
	<link rel="shortcut icon" src="imgs/favicon.ico" type="image/x-icon">
...
if($id_sesion == "gf5e70vqnl55igq1qrbff7hbf4"){
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="monitor.php"><i class="fa fa-circle-o"></i> Monitor</a></li>
				...
				<div class="col-md-12">
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane fade in" id="home">
							...
							<div class="small-box btn-warning ajuste_box">
								<div class="inner">
								  <span id="potencia_inversor" style="font-size:20px;">0</span>
								  <p>Potencia Inversor</p>
								</div>
								<div class="icon">
								  <i class="glyphicon glyphicon-flash"></i>
								</div>
						...
						<div role="tabpanel" class="tab-pane" id="messages">3...3</div>
						<div role="tabpanel" class="tab-pane" id="settings">4...4</div>
					</div>
				</div>
				</div>
	...
	<div class="row">
		...
		<div class="box box-solid bg-yellow-gradient">
            <div class="box-header">
			  ...
			  <i class="glyphicon glyphicon-flash"></i>
              <h3 class="box-title">Potencia Total & Teórica</h3>
              <div class="box-tools pull-right">
                <button type="button" class="btn bg-yellow btn-sm" data-widget="collapse"><i class="fa fa-minus"></i></button>
                <button type="button" class="btn bg-yellow btn-sm" data-widget="remove"><i class="fa fa-times"></i></button>
              </div>
            </div>
            <div class="box-body border-radius-none">
			  <iframe src="grafs/potencia_total_potencia_teorica/" style="overflow:hidden;width: 100%;border: none;border-radius: 10px;min-height: 316px;padding: 0;margin: 0;"></iframe>
            </div>
			</div>		
		</section>
...
<script>
	...
	//setInterval(function (){location.reload()}, 130000);
	document.oncopy = addLink;
	//setInterval(consulta_inicial,tiempo_actualizar1);
	//setInterval(refresh_web,900000);//900 000 -> 15min
	setInterval(function(){myTimer()}, 1000);
	setInterval(function(){listar_tabla()},tiempo_actualizar);
	
	setInterval(function(){potencia_total()},tiempo_actualizar);
	setInterval(function(){potencia_total_teorica()},tiempo_actualizar);
	setInterval(function(){potencia_bateria()},tiempo_actualizar);
	setInterval(function(){potencia_inversor()},tiempo_actualizar);
	setInterval(function(){EnergiaDiaria_Irradiadia()},tiempo_actualizar);
	setInterval(function(){EnergiaDiaria_Captada()},tiempo_actualizar);
	setInterval(function(){EnergiaDiaria_Regulador()},tiempo_actualizar);
	setInterval(function(){indicador_eficiencia()},tiempo_actualizar);
</script>
<!--
...
flush();
	...
	//header('Location: http://cdisolar.hopto.org:8889/condordorado/');
}
?>
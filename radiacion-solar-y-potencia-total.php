...
setcookie("TestCookie", $value, time()+3600, "/cookies/", "radiacion-solar-y-potencia-total.php", 1);
...
<head>
	...
	<title>CDI Radiación & Potencia| Adm: <?php echo $_SESSION['nickname'];?></title>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="radiacion-solar-y-potencia-total.php"><i class="fa fa-circle-o"></i> Radiación y Potencia[w]</a></li>
	...
	<div class="row">
		...
		<div class="box box-solid bg-red-gradient">
            <div class="box-header">
              ...
              <h3 class="box-title">Radiación Solar & Potencia Total</h3>
              <div class="box-tools pull-right">
            ...
            <div class="box-body border-radius-none">
			  <iframe src="grafs/radiacionypotencia/" style="overflow:hidden;width: 100%;border: none;border-radius: 10px;min-height: 316px;padding: 0;margin: 0;"></iframe>
            </div>
			</div>		
		</section>

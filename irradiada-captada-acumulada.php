...
setcookie("TestCookie", $value, time()+3600, "/cookies/", "irradiada-captada-acumulada.php", 1);
...
<head>
	...
	<title>CDI | Irradiada Captada Acumulada | Adm: <?php echo $_SESSION['nickname'];?></title>
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
			...
			<li class="treeview active">
				...
				<ul class="treeview-menu">
					<li class="active"><a href="irradiada-captada-acumulada.php"><i class="fa fa-circle-o"></i> Irradiada - Captada</a></li>
  ...
  <div class="content-wrapper">
	...
	<section class="col-lg-6 connectedSortable">
		...
		<div class="box-header">
		  ...
		  <h3 class="box-title">Energía Irradiada 1 semana Atras</h3>
		...
		<div class="box-body no-padding">
			<iframe src="grafs/irr_acum/" style="overflow:hidden;width: 100%;border: none;border-radius: 10px;min-height: 316px;padding: 0;margin: 0;"></iframe>
		</div>
	  </div>
	</section>
	<section class="col-lg-6 connectedSortable">
		...
		<div class="box-header">
		  <i class="fa fa-lightbulb-o"></i>
		  <i class="fa fa-sun-o"></i>
		  <h3 class="box-title">Energía Captada 1 semana Atras</h3>
		  <div class="pull-right box-tools">
			<button type="button" class="btn btn-danger btn-sm" data-widget="collapse"><i class="fa fa-minus"></i>
			</button>
			<button type="button" class="btn btn-danger btn-sm" data-widget="remove"><i class="fa fa-times"></i></button>
		...
		<div class="box-body no-padding">
			<iframe src="grafs/cap_acum/" style="overflow:hidden;width: 100%;border: none;border-radius: 10px;min-height: 316px;padding: 0;margin: 0;"></iframe>
		</div>
	  </div>
	</section>
	</div>

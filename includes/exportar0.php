...
?>
	...
	<tr>
		<td>
			<?php echo utf8_decode($resultados['id_dato']);?>
		</td>
		<td> 
			<?php
		...
		<td>
			<?php echo utf8_decode($resultados['volp1']);?>
		</td>		
		<td>
			<?php 
			$corp1 = utf8_decode($resultados['corp1']);
			echo $corp1;
			?>
		</td>		
		<td>
			<?php 
			$potp1 = utf8_decode($resultados['potp1']);
			echo $potp1;
			?>
		</td>		
		<td>
			<?php echo utf8_decode($resultados['volp2']);?>
		</td>		
		<td>
			<?php 
			$corp2 = utf8_decode($resultados['corp2']);
			echo $corp2;
			?>
		</td>		
		<td>
			<?php 
			$potp2 = utf8_decode($resultados['potp2']);
			echo $potp2;
			?>
		</td>		
			
		<td>
			<?php echo utf8_decode($resultados['volp3']);?>
		</td>		
		<td>
			<?php 
			$corp3 = utf8_decode($resultados['corp3']);
			echo $corp3;
			?>
		</td>		
		...
		<td>
			<?php 
				$potp3 = utf8_decode($resultados['potp3']);
				echo $potp3;
			?>
		</td>		
